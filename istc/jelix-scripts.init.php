...
define ('JELIX_APP_TEMP_PATH',    realpath(JELIX_APP_PATH.'../temp/istc-jelix-scripts/').'/');

// the temp path for cli scripts of the application
define ('JELIX_APP_TEMP_CLI_PATH',    realpath(JELIX_APP_PATH.'../temp/istc-cli/').'/');

// the temp path for the web scripts of the application (the same value as JELIX_APP_TEMP_PATH in application.init.php)
define ('JELIX_APP_REAL_TEMP_PATH',    realpath(JELIX_APP_PATH.'../temp/istc/').'/');
